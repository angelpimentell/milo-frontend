    ...
    return (
        <div className="w-full flex flex-col py-8 items-center justify-center">
            <div className="bg-black w-3/4 rounded">
                <li>
                    <button type="button" onClick={showCartProducts} className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
