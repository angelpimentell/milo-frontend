    ...
    return (
        <div className="w-full flex flex-col py-8 items-center justify-center">
            <div className="bg-black w-3/4 rounded">
                ...
                <button type="button" onClick={showCartProducts} className="flex items-center w-full p-2 text-2xl text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 p-5" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <span className="flex-1 ml-3 text-left whitespace-nowrap">Cart 98823</span>
